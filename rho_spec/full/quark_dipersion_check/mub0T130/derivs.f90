...
!meson and quark anomanous dimension
  ...
  real(8) dth_yukawa,dth_4fermi,dtg_etapsi
  ...
  real(8) omega,p,epsi,mp2p,ms2p,hp,dgammarho_Redt,dgammarho_Imdt,dgammarho_Re_bardt,dgammarho_Im_bardt
  real(8) gammarho_Re,gammarho_Im,dmrho2dt,mrho2,Eq
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !gammarho_Im=y(9)
  !mrho2=y(6)
  !call rhomeson(mp2p,mf2,Zphi,etaphi,etapsi,hp,l,lb,T,mu,k,omega,p,epsi,dgammarho_Redt,dgammarho_Imdt,dmrho2dt)
  dgammarho_Re_bardt=0.!(dgammarho_Redt+dmrho2dt)+etaphi*gammarho_Re*0.
  dgammarho_Im_bardt=0.!(dgammarho_Imdt)+etaphi*gammarho_Im*0.
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  dydx(6)=0.!dmrho2dt
  dydx(7)=dlam7dt
  dydx(8)=dgammarho_Re_bardt
  dydx(9)=dgammarho_Im_bardt
  dydx(Nv+1)=dlam0dt
  dydx((Nv+1)+1)=dhdt
...
!goto 200
  ...
  if(k_num1==0.or.k<k_value1)then
    ...
    write(*,"('dgammarho_Redt=', e21.14)")dgammarho_Redt
    ...
    open(unit=51,file='./buffer/gammarho_Re.dat',position='append')
    write(51, "(e21.14)")gammarho_Re
    close(51)

    open(unit=51,file='./buffer/gammarho_Im.dat',position='append')
    write(51, "(e21.14)")gammarho_Im
    close(51)

    open(unit=51,file='./buffer/mrho2.dat',position='append')
    write(51, "(e21.14)")mrho2
    close(51)
    ...
    open(unit=51,file='./buffer/Eq.dat',position='append')
    write(51, "(e21.14)")sqrt(k**2+mf2*k**2)*197.33
    close(51)
