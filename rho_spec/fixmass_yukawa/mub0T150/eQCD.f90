...
!order of chebyshev polynomial
  ...
  open(unit=1,file='../data/mub0/buffer/h.dat')
  read(1,*) hindata
  close (1)

  open(unit=1,file='../data/mub0/buffer/Zphi.dat')
  read(1,*) Zindata
  close (1)

  open(unit=1,file='../data/mub0/buffer/mf.dat')
  read(1,*) mfindata
  close (1)
  ...
  close (1)
  iTin=150
  hin=hindata(iTin)*sqrt(Zindata(iTin))
  mfin=mfindata(iTin)
  l_i=lindata(iTin)
  lb_i=lbindata(iTin)
